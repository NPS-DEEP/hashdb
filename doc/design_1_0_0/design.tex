...
Changes to the \hdb are noted in the \hdb changed object.
...
\begin{small}
\begin{verbatim}
is_positive(const md5_t &md5);
\end{verbatim}
\end{small}


\subsection{\hdb Settings}
Many of the storage types in the \hdb database use configurable settings.
