...
\begin{small}
\begin{verbatim}
map_multimap_manager_t(const std::string& hashdb_dir,
...
\texttt{map\_multimap\_iterator\_t} dereferences to \\
...
\texttt{pair<string hexdigest, uint64\_t source\_lookup\_encoding>}.
