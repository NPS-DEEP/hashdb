...
This section describes the data that \hdb stores with hashes and sources. How this data is used to classify blocks as nonprobative is a complex issue. \hdb stores this data. It is up to post-processing tools such as \sscope to evaluate it.

\begin{itemize}
\item \textbf{Entropy}\\
One measure of how probative a block might be is its entropy. Blocks with a low entropy value are often nonprobative. \hdb calculates the Shannon entropy of blocks using an alphabet of $2^{16}$ values.\\
\end{itemize}
...
\begin{Verbatim}[commandchars=\\\{\}]
\verbbf{hashdb sizes mock_video.hdb}
\end{Verbatim}
