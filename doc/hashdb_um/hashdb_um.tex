...
\item \textbf{Source-Offset Pairs}\\
  The list of source-offset pairs identify all sources the matched hash maps to, along with the offset in the sources where the match is located.
\end{itemize}
