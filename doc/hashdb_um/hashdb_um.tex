...
\hline
\verb+hash_data_offset_inserted+ &  Total number of file offset values that were actually recorded.\\
\hline
\verb+hash_data_data_changed+ &  Number of hash data records that changed.\\
\hline
\verb+hash_data_duplicate_off+- \verb+set_detected+ &  Number of file offset values already present in insert, should be zero.\\
\hline
...
\item \verb+manager.insert_hash(block_hash, k_entropy, block_label, file_hash,+\\
...
\item \verb+bool find_hash(block_hash, &k_entropy, &block_label, &count, source_offsets)+\\
