...
Byte alignment is an optimization parameter created to help make a smaller database. Use the block step size unless you want to hash blocks along unaligned boundaries. For storage devices, use the sector size since this the smallest value that data in storage devices can align to, which is 512. The default is 512.\\
