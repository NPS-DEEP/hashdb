...
\textbf{Command} & \textbf{Usage} & \textbf{Description} \\
\hline
\textbf{ingest} & \verb+ingest [-r <repository name>]+ \verb+[-w <whitelist.hdb>]+ \verb+[-s <step size>]+ \verb+<hashdb.hdb>+ \verb+<source directory>+& Computes and imports hashes from files under the source directory.\\
\hline
