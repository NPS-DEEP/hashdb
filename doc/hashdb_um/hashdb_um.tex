...
\item \textbf{export}\\
Exports values from a \hdb block hash database. Data is in JSON format as described in \textbf{\autoref{ImportExportSyntax}}. The following example exports everything in database \verb+demo.hdb+ to file, \verb+demo.json+:
\begin{Verbatim}[commandchars=\\\{\}]
