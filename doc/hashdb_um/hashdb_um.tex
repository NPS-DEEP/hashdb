...
The \textit{LMDB Hash Data Store} uses three tuning parameters to minimize data store size: \verb+max_count+, \verb+max_sub_count+, and \verb+block_size+.  These parameters are described in \textbf{\Autoref{Settings}}.\\
