...
\item \verb+ingest(hashdb_dir, ingest_path, step_size, repository_name,+\\
\verb+whitelist_dir, process_embedded_data, command_string)+\\
Recursively calculate and import hashes from path to \hdb. zzz NOT AVAILABLE IN ALPHA.
\item \verb+scan_image(hashdb_dir, media_image_file, step_size, process_embedded_data)+\\
Scan the media image for matches. zzz NOT AVAILABLE IN ALPHA.
\end{itemize}
