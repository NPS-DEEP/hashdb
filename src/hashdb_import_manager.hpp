...
#ifndef HASHDB_IMPORT_MANAGER_HPP
#define HASHDB_IMPORT_MANAGER_HPP
#include "globals.hpp"
...
class hashdb_import_manager_t {
  ...
  hashdb_import_manager_t(const hashdb_import_manager_t&);
  hashdb_import_manager_t& operator=(const hashdb_import_manager_t&);

  public:
  hashdb_import_manager_t(const std::string& p_hashdb_dir,
