...
void detailed_usage() {
  ...
  << "The bulk_extractor hashid scanner provides two capabilities: 1) scanning\n"
  << "a hash database for previously encountered hash values, and 2) importing\n"
  << "block hashes into a new hash database.  Options that control the hashid\n"
  ...
  << "information on usage of the hashid scanner.  Note that the hashid scanner\n"
