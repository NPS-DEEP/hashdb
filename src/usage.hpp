...
void usage() {
  ...
  << "    <hashdb>       the hash database to remove matching hashes from\n"
  << "\n"
  << "deduplicate <hashdb1> <hshdb2>\n"
  << "    Copy hall hashes in <hashdb1> to <hashdb2> except for hashes with\n"
  << "    duplicates.\n"
  << "\n"
  << "    Parameters:\n"
  ...
  << "    <output text file> the output text file containing hashes and where\n"
