...
void usage() {
  ...
  << "\n"
  << "statistics <hashdb>\n"
  << "    Prints out statistics about the given <hashdb> database.\n"
  << "\n"
  << "    Parameters:\n"
...
*/
  ...
  << "path my_hashdb at port number \"14500\":\n"
  << "    hashdb server my_hashdb 14500\n"
  << "\n"
  ...
  << "\n"
  << "This example searches my_hashdb for hashes that match those in DFXML file\n"
  << "my_dfxml and directs expanded output to stdout:\n"
  << "    hashdb scan_expanded my_hashdb my_dfxml\n"
  << "\n"
  ...
  << "    hashdb sources my_hashdb\n"
  << "\n"
  << "This example prints out size information about the hash database at file\n"
  << "path my_hashdb:\n"
  << "    hashdb size my_hashdb\n"
  << "\n"
  << "This example prints out statistics about the hash database at file path\n"
  << "my_hashdb:\n"
  << "    hashdb statistics my_hashdb\n"
  << "\n"
  << "This example prints out duplicate hashes in my_hashdb that have been\n"
  << "sourced 20 times:\n"
  << "    hashdb duplicates my_hashdb 20\n"
  << "\n"
  ...
  << "    bulk_extractor -e hashid -S hashdb_mode=scan\n"
  << "    -S path_or_socket=my_hashdb -o my_scan my_image\n"
  << "\n"
  ...
  << "    bulk_extractor -e hashid -S hashdb_mode=import -o my_scan my_image\n"
  << "\n"
