...
//  << "  -H, --Help         print detailed help including usage notes and examples\n"
  ...
  << "    Scans the <hashdb> for hashes that match hashes in the <DFXML file>\n"
  << "    and prints out matches showing all sources.\n"
  << "\n"
  << "    Parameters:\n"
  << "    <hashdb>          the file path to the hash database to use as the\n"
  << "                      lookup source\n"
  ...
  << "    Prints out the hashes and offsets from the given <hashdb> database\n"
  << "    for the <repository name> and <filename> source requested.\n"
  << "\n"
  << "    Parameters:\n"
  ...
  << "                              by bulk_extractor\n"
  << "\n"
  << "  explain_identified_blocks [-m <number>] <hashdb>\n"
  << "                            <identified_blocks.txt> <number>\n"
