...
void usage() {
  ...
  << "\n"
  << "    Parameters:\n"
  << "    <source hashdb>       the hash database to entirely remove\n"
  << "                              duplicated hashes from\n"
  << "\n"
  << "  scan <path_or_socket> <DFXML file>\n"
  << "    Scans the <path_or_socket> for hashes that match hashes in the\n"
  << "    <DFXML file> and prints out matches.\n"
  << "\n"
  << "    Parameters:\n"
  << "    <path_or_socket>  the file path or socket endpoint to the hash\n"
  ...
  << "    as sourced in <hashdb>.  Source information includes repository name,\n"
  << "    filename, and file offset.\n"
  << "\n"
  << "    Parameters:\n"
  << "    <hashdb>       the hash database to use as the lookup source\n"
  << "    <identified_blocks.txt>   the identified blocks feature file\n"
  << "\n"
  ...
  << "    Rebuilds the bloom filters in the <hashdb> hash database based on\n"
  << "    the <bloom filter settings> provided.\n"
  << "\n"
  << "    Options:\n"
  << "    --bloom1 <state>\n"
  << "      sets bloom filter 1 <state> to enabled | disabled (default " << bloom_state_to_string(s.bloom1_is_used) << ")\n"
  ...
  << "\n"
  << "    Parameters:\n"
  << "    <hashdb>       a hash database for which the bloom filters will be\n"
  << "                   rebuilt\n"
  << "\n"
  << "Analysis:\n"
  ...
  << "    Imports hashes from my_image1 to outdir/hashdb.hdb\n"
  << "\n"
  << "  bulk_extractor -e hashdb -S hashdb_mode=scan\n"
  << "                 -S hashdb_scan_path_or_socket=outdir1/hashdb.hdb\n"
  << "                 -o outdir2 my_image2\n"
  << "    Scans hashes from my_image2 agains hashes in outdir1/hashdb.hdb\n"
  << "\n"
  ;
}
