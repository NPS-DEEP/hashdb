...
void usage() {
  ...
  << "\n"
  << "add <source hashdb 1> <source hashdb 2> <destination hashdb>\n"
  ...
  << "\n"
  << "get_hash_source <identified_blocks.txt> <identified_sources.txt>\n"
  << "    Expands the <identified_blocks.txt> file generated by bulk_extractor\n"
  << "    into new file <identified_sources.txt> to indicate where the hash\n"
  << "    values are sourced from.\n"
  << "\n"
  << "print_sources <hashdb>\n"
  << "    Prints out all the repository name, filename sources present in the\n"
  << "    hash database.\n"
  ...
  << "\n"
  << "get_hashdb_info <hashdb>\n"
  << "    Print out information about the specified hash database.\n"
  << "\n"
  << "    Parameters:\n"
  << "    <hashdb>       the hash database to print information about\n"
  << "\n"
