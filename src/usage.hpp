...
void usage() {
  ...
  << "    --bloom1_n <n>\n"
  << "      expected total number <n> of unique hashes (default " << bloom_filter_manager_t::approximate_M_to_n(s.bloom1_M_hash_size) << ")\n"
  << "    --bloom1_kM <k:M>\n"
  ...
  << "                          hashes appear only once\n"
  << "\n"
  << "  scan <path or socket> <DFXML file>\n"
  << "    Scans the <path or socket> for hashes that match hashes in the\n"
  << "    <DFXML file> and prints out matches.\n"
  << "\n"
  << "    Parameters:\n"
  << "    <path or socket>  the file path or socket endpoint to the hash\n"
  ...
  << "    Parameters:\n"
  << "    <hashdb>                  the hash database to use as the lookup source\n"
  << "    <identified blocks file>  the identified blocks feature file\n"
  << "\n"
