...
void detailed_usage() {
  ...
  << "\"--query\" tells hashdb_checker to perform a hash query.\n"
  << "\"-S tcp://localhost:14501\" tells the scanner to perform queries using a\n"
  << "query server at socket endpoint \"tcp://localhost:14501\".  hashdb_manager\n"
  ...
  << "Please see the example for starting hashdb_manager as a server query service.\n"
  << "File \"my_dfxml\" is the name of the DFXML file containing hashes that will\n"
  << "be scanned for.\n"
  << "Output is directed to stdout.\n"
  << "    hashdb_checker --query -S tcp://localhost:14501 my_dfxml\n"
  << "\n"
