...
void usage() {
 ...
 << "\n"
  ...
  << "queries:\n"
  << "    --b1 <state>\n"
  << "        sets bloom filter 1 <state> to enabled | disabled (default " << ((s.bloom1_is_used == true) ? "enabled" : "disabled") << ")\n"
  << "    --b1n <n>\n"
  ...
  << "    --b2 <state>\n"
  << "        sets bloom filter 2 <state> to enabled | disabled (default " << ((s.bloom2_is_used == true) ? "enabled" : "disabled") << ")\n"
  << "    --b2n <total>\n"
